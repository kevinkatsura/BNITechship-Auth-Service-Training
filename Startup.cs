...
namespace AlphaAuthService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AlphaAuthService", Version = "v1" });
            });
            ...
            }).AddDefaultTokenProviders().AddEntityFrameworkStores<BNITechshipContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AlphaAuthService v1"));
            }
